"""
Starter fabfile for deploying the captricity project.
...
# CHANGEME
env.hosts = ['user@captricity.example.com']
env.code_dir = '/srv/www/captricity'
env.project_dir = '/srv/www/captricity/captricity'
env.static_root = '/srv/www/captricity/static/'
env.virtualenv = '/srv/www/captricity/.virtualenv'
env.code_repo = 'git@github.com:user/captricity.git'
env.django_settings_module = 'captricity.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/captricity/wsgi.py" % env.code_dir)
